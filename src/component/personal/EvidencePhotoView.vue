<template>
    <div class="home-container">
        ...
        <div class="card-container">
            <img v-if="showImg" :src="imgSrc" alt="" style="width: 100%;">
        </div>
    </div>
</template>
...
export default {
    ...
    computed: {
        imgSrc: function () {
            return httpurl + 'file/download?fileName='+this.file_name+'&fileType='+this.file_type+'&caseID='+this.case_id+'&taskID='+this.task_id;
        },
        file_type () {
            return this.$route.query.file_type || "";
        },
        file_name () {
            return this.$route.query.file_name || "";
        },
        case_id () {
        ...
        showImg: function () {
            return true;
            if (this.file_type !== "" && this.file_type !== "" && this.case_id !== "" && this.task_id !== "") {
                return true
            } else {
                return false
            }
