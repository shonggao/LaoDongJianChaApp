<template>
    <div class="home-container">
        <header id="header" class="mui-bar mui-bar-nav">
            ...
            <a class="mui-pull-right mui-icon mui-icon-right-nav" @click="editInspectionCompany">完成</a>
        </header>
...
export default{
    ...
    methods: {
        getInspectionCompany(){
            // this.getCompanyList();
            this.pd = this.$store.state.inspectionList[this.id];
        },
        goBack(){
            this.$router.replace("/companymanager/inspectioncompanylist"); 
        },
        editInspectionCompany(){
            // 修改企业信息
            ...
            if (this.pd.DWMC == ""){
                ...
                var inspectionCompany = {
                    QIYEXINXIGUANLI_ID:this.pd.QIYEXINXIGUANLI_ID || "",
                ...
                // 增加企业信息
                this.$http.post('qiyexinxiguanli/edit',inspectionCompany, {withCredentials: true}).then(result => {
                    // console.log(result);
                    if( result.body.result == "success" ){
                        // this.$store.commit("updateInspectionCompany",{
                        //     index: this.id,
