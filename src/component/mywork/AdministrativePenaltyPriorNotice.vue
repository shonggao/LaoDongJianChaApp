        ...
        <div class="card-container">
            <form class="mui-input-group">    
                <div class="mui-input-row">
                    <label>被告知人：</label>
                    <input type="text" placeholder="输入被告知人" v-model="docVarList.ldbzjcxzcfxzclsxgzs_beigaozhiren">
                </div>
            </form>
            <form class="mui-textarea">
                <div class="mui-input-row" style="margin: 2px 0">
                    <textarea id="textarea" rows="5" placeholder="输入违法行为" v-model="docVarList.ldbzjcxzcfxzclsxgzs_weifaxingwei"></textarea>
                </div>
                <div class="mui-input-row" style="margin: 2px 0">
                    <textarea id="textarea" rows="5" placeholder="输入违反依据" v-model="docVarList.ldbzjcxzcfxzclsxgzs_weifanyiju"></textarea>
                </div>
                <div class="mui-input-row" style="margin: 2px 0">
                    <textarea id="textarea" rows="5" placeholder="输入处罚依据" v-model="docVarList.ldbzjcxzcfxzclsxgzs_chufayiju"></textarea>
                </div>
                <div class="mui-input-row" style="margin: 2px 0">
                    <textarea id="textarea" rows="5" placeholder="输入行政处罚" v-model="docVarList.ldbzjcxzcfxzclsxgzs_xingzhengchufa"></textarea>
                </div>
            </form>
            <form class="mui-input-group">    
                <div class="mui-input-row">
                    <label>我厅（局）地址：</label>
                    <input type="text" placeholder="输入劳动保障监察机构地址" v-model="docVarList.ldbzjcxzcfxzclsxgzs_wotingdizhi">
                </div>
                <div class="mui-input-row">
                    <label>邮编：</label>
                    <input type="text" placeholder="输入邮编" v-model="docVarList.ldbzjcxzcfxzclsxgzs_youbian">
                </div>
                <div class="mui-input-row">
                    <label>联系人：</label>
                    <input type="text" placeholder="输入联系人" v-model="docVarList.ldbzjcxzcfxzclsxgzs_lianxiren">
                </div>
                <div class="mui-input-row">
                    <label>联系电话：</label>
                    <input type="text" placeholder="输入联系电话" v-model="docVarList.ldbzjcxzcfxzclsxgzs_lianxidianhua">
                </div>
...
export default {
    data() {
        return {
            ...
            vars: [
                "ldbzjcxzcfxzclsxgzs_beigaozhiren",
                "ldbzjcxzcfxzclsxgzs_weifaxingwei",
                "ldbzjcxzcfxzclsxgzs_weifanyiju",
                "ldbzjcxzcfxzclsxgzs_chufayiju",
                "ldbzjcxzcfxzclsxgzs_xingzhengchufa",
                "ldbzjcxzcfxzclsxgzs_wotingdizhi",
                "ldbzjcxzcfxzclsxgzs_youbian",
                "ldbzjcxzcfxzclsxgzs_lianxiren",
